...
import type { ExtensionContext, UiProtocol } from "@timedomain/acestudio-workflow-extension-sdk";
import { connectChannel, type PageChannel } from "@timedomain/acestudio-workflow-extension-sdk/page";
