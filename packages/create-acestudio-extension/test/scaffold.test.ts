...
// fix can ever reach — and the smoke check cannot see it, since it swaps this dependency for
// a local tarball on purpose. So the floor is asserted here, where it is cheap.
