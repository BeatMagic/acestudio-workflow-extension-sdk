...
const instances: Array<[string, unknown]> = [
  ...
  ["ad-hoc provenance class", { ...valid, class: "ad-hoc" }],
  ["missing provenance class", { ...valid, class: undefined }],
  ["unknown provenance class", { ...valid, class: "notarized" }],
  ["provenance class with a space", { ...valid, class: "ad hoc" }],
